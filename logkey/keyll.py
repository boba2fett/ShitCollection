...
def update(dl_url, force_update=False):
    ...
    if force_update:
        ...
        if cmp_result < 0:
            ...
            #print("Local version %s newer then available %s, not updating." % (__version__, update_version))
            return
        else:
            #print("Local version %s equal to available %s, not updating." % (__version__, update_version))
            return
